...
Funcionalidade de detalhamento de um cliente selecionado (0,5) * Exportação de relatórios do consolidado geral e de um cliente específico nos formatos CSV ou JSON (0,5)
...
Autenticação dos clientes e controle de acesso por perfil (0,3) * Auditoria no servidor, registrando ações executadas, responsáveis e data/hora (0,2)
